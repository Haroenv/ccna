...
You can name a cisco device by entering the `hostname "[name]"` command.

## Message of the day

You can set a message of the day using the `banner motd "[message]"` command.

## Disable DNS-lookup

You can disable DNS-lookup using the `no ip domain-lookup` command.
